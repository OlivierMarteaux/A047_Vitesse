        ...
        suspend fun populateDatabase(applicantDao: ApplicantDao) {
            val prepopulatedApplicants = listOf(
                Applicant(
                    ...
                    salary = 40000.0,
                    note = "Olivier’s application immediately caught our attention at Vitesse. With 16 years of experience in the aerospace industry as a Product Architect, Mechanical Engineer, and M&P specialist, he brings an exceptional mindset shaped by rigor, high standards, and technical leadership. What stands out most is how he turned a career setback into a bold and inspiring transition toward Android development. The day after being laid off, he started retraining—first through Google’s Android Basics and now halfway through a full Android Developer path at OpenClassrooms. His proactive attitude, clear goals, and strong learning ethic reflect both resilience and vision. Olivier is not only technically curious—exploring Jetpack Compose, Room, and REST APIs—but he’s also eager to contribute, as shown by his growing GitHub and online presence. His profile combines maturity, structure, and a genuine passion for mobile technologies. We’re eager to consider how he could bring value to our Android team.",
